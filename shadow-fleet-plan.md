...
27. OFAC change-archive parser fixed against the live files (Sep 17): text archives date their sections with 2-digit years (`01/05/23:`) and wrap the "The following ... have been / added to OFAC's SDN List:" heading across lines, so the first run attached no date to any of 7,093 (2023) and 15,978 (2025) entries. With both fixed the parser reads 545 vessel entries and 540 IMOs for 2025 (444 adds, 88 modifies, 13 removes), and 301/300 for 2023.
